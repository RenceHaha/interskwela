    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          const TextSpan(
                              text: "Teacher Name", // Replace with author name if available
                              style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black87)),
                          TextSpan(text: " • ${_formatDateFull(classwork.dateUpdated)}"),
                        ],
                      ),
                    ),
          ...
          // --- Description ---
          if (classwork.instruction != null && classwork.instruction!.isNotEmpty) ...[
            Text(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Text(
                  "Rubric: 2 criteria • 50 pts", // Placeholder text
          ...
          Row(
            children: const [
              ...
              SizedBox(width: 8),
              Text("Class comments", style: TextStyle(fontWeight: FontWeight.w500)),
            ],
          ),
          const SizedBox(height: 16),
          Row(
