...
class TeacherClassessScreen extends StatefulWidget {
  const TeacherClassessScreen({super.key});

  @override
  State<TeacherClassessScreen> createState() => _TeacherClassessScreenState();
}

class _TeacherClassessScreenState extends State<TeacherClassessScreen> {
                ...
                return GestureDetector(
                  onTap: () => {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TeacherClassScreen(specificCLass: cl, userId: userId!),
                      ),
                    ),
                  },
                  child: ClassCard(
